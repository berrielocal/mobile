...
class _CommentService implements CommentService {
  ...
  @override
  Future<CommentsResponse> getComments({required int shopId}) async {
  ...
  @override
  Future<void> postComment({required CommentCreateRequest request}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
